...
def timefrequency_scattering1d(
        x, Tx, unpad, backend, J, log2_T, psi1, psi2, phi, scf,
    ...
    - unpad_len_common_at_max_fr_stride = (ind_end_fr_common[stride_at_max_fr] -
                                           ind_start_fr_common[stride_at_max_fr])
    - rename: ind_end_fr_max -> ind_end_fr_common  # TODO
    __________________________________________________________________________
    ...
    - `n1_fr` == number of frequential joint slices (or their indexing), or
      `psi1_f_fr_*`, per `n2`
    - `n2` == number of `psi2` wavelets (or their indexing), together with
