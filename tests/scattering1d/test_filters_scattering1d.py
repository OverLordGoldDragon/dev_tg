...
from wavespin.scattering1d.filter_bank import (
    adaptive_choice_P, periodize_filter_fourier, get_normalizing_factor,
    compute_sigma_psi, compute_temporal_support, compute_xi_max, morlet_1d,
    calibrate_scattering_filters, get_max_dyadic_subsampling, gauss_1d)
import numpy as np
import math
import pytest
...
if __name__ == '__main__':
    if run_without_pytest:
        ...
        test_periodize_filter_fourier()
        test_get_normalizing_factor()
        test_compute_temporal_support()
        test_compute_xi_max()
        test_morlet_1d()
        test_calibrate_scattering_filters()
        test_get_max_dyadic_subsampling()
        test_gauss_1d()
    else:
