...
from wavespin.scattering1d.frontend.torch_frontend import ScatteringTorch1D
from wavespin.scattering1d.utils import compute_border_indices, compute_padding
...
def test_scattering1d_frontend():
    ...
    assert isinstance(scattering, ScatteringTorch1D
